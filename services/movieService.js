...
class movieService{
    ...
    async insertOne(body){
        ...
        try {
            ...
            const result = await client.db("motorbike ").collection("usuarios").insertOne(body);
            return result
        }catch(e){
            console.log(e);
        }finally{
    ...
    async find(limit, offset){
        ...
        try{
            await client.connect();
            const movies = await client.db("motorbike").collection("usuarios").find({}).skip(Number(offset)).limit(Number(limit)).toArray();
            return movies;
        }catch(e){
            console.log(e);
        }finally{
